      ...
      const validarCampo = (campo) => {
        switch (campo) {
          ...
          case 'contrasena':
            ...
            const longitudValida = datos.contraseña.length > 8;
      
            
            const tieneDigito = /\d/.test(datos.contraseña);
      
            
            const tieneMayuscula = /[A-Z]/.test(datos.contraseña);
    ...
    return(
      <div className='regis-form'>
        ...
        <form method="post"  onSubmit={(e)=>{handleSubmit(e)}}>
            ...
            name="contraseña" 
            required 
            onFocus={() => handleInputFocus('contraseña')}
            onChange={(event) => handleInputChange('contraseña', event.target.value)}
            style={{ borderColor: validacion.contraseña ? 'green' : 'red' }}
            /><br />   
