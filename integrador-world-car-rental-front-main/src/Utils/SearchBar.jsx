...
const SearchBar = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://localhost:8080/vehiculo/vehiculos')
      .then(response => {
        if (!response.ok) {
            ...
            <ul className='result-content'>
              {resultadosAutos.map(auto => (
                <div className='card-result'>
                  <li key={auto.id}>
                    <img src={auto.imagen} alt="Imagen del auto" style={{ borderRadius: "6px", marginTop: "20px", width: "50%" }} />
