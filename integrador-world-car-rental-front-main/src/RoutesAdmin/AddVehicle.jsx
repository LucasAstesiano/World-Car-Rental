...
const AddVehicle = () => {
  ...
  const url = "http://localhost:8080/vehiculo/registrar"
    ...
    <section className='add-vehicle'>
      ...
      <form method="post" className='form-add' onSubmit={(e) => { handleSubmit(e) }}>
        ...
        <div className="form-group">
          ...
          <input type="number" className="form-control" id="califiacion" name="califiacion" required onChange={(event) => setDatos({ ...datos, califiacion: event.target.value })} />
        </div>
