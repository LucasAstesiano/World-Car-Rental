...
const ListVehicle = () => {
  ...
  const url = "http://localhost:8080/vehiculo/vehiculos"
  ...
  const handleDelete = (idToDelete) => {
    ...
    const url = `http://localhost:8080/vehiculo/eliminar/${idToDelete}`
        ...
        {vehiculos.map((vehicle, index) => (
          <tr key={index}>
            ...
            <td className='btn-table'>
              ...
              <button onClick={() => { handleDelete(vehicle.id) }} className='btn-delete'>ELIMINAR</button></td>
          </tr>
        ))}
