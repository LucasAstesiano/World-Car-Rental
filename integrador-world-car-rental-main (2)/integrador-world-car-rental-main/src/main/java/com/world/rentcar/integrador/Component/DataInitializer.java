...
//        Puntuacion puntuacion = new Puntuacion(null,null,null,5);


//        Vehiculo vehiculo1 = new Vehiculo(null,"Corolla","Toyota",8900000.0,true,"Auto",5,"Confort y confianza en todo momenro","electrico","1.9","Automatico","ldm7126",Arrays.asList(null),5,Arrays.asList("1.9","1.9","1.9","1.9"),sucursal1,);
//        Vehiculo vehiculo1 = new Vehiculo(
//                1L, "Sedan", "Toyota", 25000.0, true, "Automóvil", 5,
//                "Automóvil familiar con amplio espacio.", "Motor de 2.0 litros",
//                "2000 cc", "Automática", "ABC123", 5,
//                Arrays.asList("imagen1.jpg", "imagen2.jpg", "imagen3.jpg"),
//                sucursal1, new ArrayList<>(), new ArrayList<>(), new ArrayList<>()
//        );
//
//        Vehiculo vehiculo2 = new Vehiculo(
//                2L, "Hatchback", "Honda", 22000.0, true, "Automóvil", 4,
//                "Compacto y ágil para la ciudad.", "Motor de 1.6 litros",
//                "1600 cc", "Manual", "XYZ456", 4,
//                Arrays.asList("imagen4.jpg", "imagen5.jpg", "imagen6.jpg"),
//                sucursal1, new ArrayList<>(), new ArrayList<>(), new ArrayList<>()
//        );
//
//        Vehiculo vehiculo3 = new Vehiculo(
//                3L, "SUV", "Ford", 30000.0, true, "Automóvil", 5,
//                "Espacioso y versátil para aventuras familiares.", "Motor de 2.5 litros",
//                "2500 cc", "Automática", "DEF789", 4,
//                Arrays.asList("imagen7.jpg", "imagen8.jpg", "imagen9.jpg"),
//                sucursal1, new ArrayList<>(), new ArrayList<>(), new ArrayList<>()
//        );
//
//        Vehiculo vehiculo4 = new Vehiculo(
//                4L, "Crossover", "Nissan", 28000.0, true, "Automóvil", 5,
//                "Combina lo mejor de SUV y sedán.", "Motor de 2.2 litros",
//                "2200 cc", "Automática", "MNO321", 5,
//                Arrays.asList("imagen16.jpg", "imagen17.jpg", "imagen18.jpg"),
//                sucursal1, new ArrayList<>(), new ArrayList<>(), new ArrayList<>()
//        );
//
